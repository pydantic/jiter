...
fn round_trip_all() {
    let v: JsonValue<'static> = JsonValue::Object(Arc::new(LazyIndexMap::from(vec![
        ...
        (
            "header-array".into(),
            JsonValue::Array(Arc::new(smallvec![JsonValue::Int(6), JsonValue::Bool(true),])),
        ),
        // i64 array
        (
            "i64-array".into(),
        ...
        (
            "u8-array".into(),
            JsonValue::Array(Arc::new(smallvec![JsonValue::Int(42), JsonValue::Int(255),])),
        ),
    ])));
    ...
    let json = r#"
        {
            ...
            "big_int": [92233720368547758070,-92233720368547758080],
            "true": true,
            "false": false,
            "null": null,
            "" : "empty-key"
